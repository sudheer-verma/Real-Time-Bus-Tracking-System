  ...
  return (
    <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
      <div className="flex items-center justify-between gap-4">
        <div>
          <p className="text-xs uppercase tracking-[0.3em] text-amber-600">Profile</p>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-2xl bg-slate-50 p-4"><p className="text-xs uppercase tracking-[0.2em] text-slate-500">Access level</p><p className="mt-2 text-lg font-semibold text-amber-600">Administrator</p></div>
      </div>
    </div>
  );
};
